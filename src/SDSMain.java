...
import projeto.ci.util.Normalizar;
...
public class SDSMain {
	...
	public static void main(String[] args) throws IOException {
		...
		do {
			...
			System.out.println("---------------");
			System.out.println(
					"Generation: " + geracao + " | Fitness: " + Arrays.toString(pop.getIndividuo(0).getFitness())
							+ " | Individuo: " + Arrays.toString(pop.getIndividuo(0).getGenes()));
			System.out.println("---------------");
			if (temSolucao = alg.hasSolucao(pop.getIndividuo(0)))
				System.out.println("Solução: " + Arrays.toString(pop.getIndividuo(0).getGenes())
